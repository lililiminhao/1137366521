...
public class Encryptor {
	/** 输出日志 */
	public static final String HUNDSUN_VERSION = "@system  统一消息平台 @version 3.0.2.1 @lastModiDate @describe ";
	/** 构造 */
	...
	public byte[] encrypt(byte[] idata) {
		...
		if (leftdata != 0) {
			...
			for (int k = leftdata; k < BLOCK_SIZE; k++) {
				// temp[k] = (byte) (BLOCK_SIZE - leftdata); //MODIFIED BY JYH
				// 20080610 鍙戠幇涓庡悗鍙皍nix绔殑鍔犲瘑绠楁硶涓嶄竴鑷�
				temp[k] = '\0';
			}
